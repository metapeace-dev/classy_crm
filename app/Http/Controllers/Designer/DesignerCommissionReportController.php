...
class DesignerCommissionReportController extends DesignerBaseController
{
    ...
    public function index() {
        ...
        return view('designer.reports.commissions.index', $this->data);
    }
    ...
    public function individualReport() {
        ...
        return view('designer.reports.commissions.individual', $this->data);
    }
    ...
    public function individualData(Request $request) { //$startDate = null, $endDate = null, $client = null, $project = null
        ...
        return DataTables::of($commissions)
            ->addColumn('action', function ($row) {
                $string = '<a href="' . route('designer.commission-report.export-pdf', $row->project_id) . '" class="btn btn-info btn-circle"
...
//        return view('designer.reports.commissions.report-pdf', $this->data);
        $pdf = app('dompdf.wrapper');
        $pdf->loadview('designer.reports.commissions.report-pdf', $this->data);
