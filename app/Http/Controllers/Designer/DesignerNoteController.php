...
class DesignerNoteController extends DesignerBaseController
{
    ...
    public function createLeadNote($id)
    {
        ...
        return view('designer.note.create-note', $this->data);
    }
...
//    }
    ...
    public function edit($id)
    {
        ...
        return view('designer.lead-settings.source.edit', $this->data);
    }

    public function editNote($id)
    {
        $this->note = Note::findOrFail($id);
        return view('designer.lead.update-source', $this->data);
    }
