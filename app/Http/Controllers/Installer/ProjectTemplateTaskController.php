...
class ProjectTemplateTaskController extends InstallerBaseController
{
    ...
    public function store(StoreTask $request)
    {
        ...
        $view = view('installer.project-template.tasks.task-list-ajax', $this->data)->render();
    ...
    public function show($id)
    {
        ...
        return view('installer.project-template.tasks.show', $this->data);
    }
    ...
    public function edit($id)
    {
        ...
        $view = view('installer.project-template.tasks.edit', $this->data)->render();
