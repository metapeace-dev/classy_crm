...
class InstallerNoteController extends InstallerBaseController
{
    ...
    public function createLeadNote($id)
    {
        ...
        return view('installer.note.create-note', $this->data);
    }
...
//    }
    ...
    public function edit($id)
    {
        ...
        return view('installer.lead-settings.source.edit', $this->data);
    }

    public function editNote($id)
    {
        $this->note = Note::findOrFail($id);
        return view('installer.lead.update-source', $this->data);
    }
