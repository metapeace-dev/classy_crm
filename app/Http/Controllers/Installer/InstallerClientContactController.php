...
class InstallerClientContactController extends InstallerBaseController
{
    ...
    public function show($id) {
        ...
        return view('installer.client-contacts.show', $this->data);
    }
    ...
    public function edit($id) {
        ...
        return view('installer.client-contacts.edit', $this->data);
    }
