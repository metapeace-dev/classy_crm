...
class InstallerAttendanceController extends InstallerBaseController
{
    ...
    public function index()
    {
        ...
        return view('installer.attendance.index', $this->data);
    }
    ...
    public function create()
    {
        ...
        return view('installer.attendance.create', $this->data);
    }
    ...
    public function employeeData(Request $request, $startDate = null, $endDate = null, $userId = null){
        ...
        // Getting View data
        $view = view('installer.attendance.user_attendance', ['dateWiseData' => $dateWiseData,'global' => $this->global])->render();
    ...
    public function data(Request $request){
        ...
        return DataTables::of($attendances)
            ->editColumn('id', function ($row) {
                return view('installer.attendance.attendance_list', ['row' => $row, 'global' => $this->global, 'maxAttandenceInDay' => $this->maxAttandenceInDay])->render();
            })
            ->rawColumns(['id'])
            ->removeColumn('name')
    ...
    public function attendanceDetail(Request $request)
    {
        ...
        return view('installer.attendance.attendance-detail', $this->data)->render();
    }
