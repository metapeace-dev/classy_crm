...
class InstallerProposalController extends InstallerBaseController
{
    ...
    public function Index() {
        ...
        return view('installer.proposals.index', $this->data);
    }

    public function show($id) {

        $this->lead = Lead::where('id', $id)->first();
        return view('installer.proposals.show', $this->data);
    }
    ...
    public function data($id = null) {
        ...
        return DataTables::of($lead)
            ...
            ->editColumn('name', function ($row) {
                if($row->client_id){
                    return '<a href="' . route('installer.clients.projects', $row->client_id) . '">' . ucwords($row->name) . '</a>';
                }
    ...
    public function create($leadID = null) {
        ...
        return view('installer.proposals.create', $this->data);
    }
...
//        $notifyUser->notify(new NewProposal($proposal));
        ...
        return Reply::redirect(route('installer.proposals.show', $proposal->lead_id), __('messages.proposalCreated'));
    ...
    public function edit($id) {
        ...
        return view('installer.proposals.edit', $this->data);
    }
...
//        $notifyUser->notify(new NewProposal($proposal));
        ...
        return Reply::redirect(route('installer.proposals.show', $proposal->id), __('messages.proposalUpdated'));
    ...
    public function download($id) {
        ...
        $pdf->loadview('installer.proposals.proposal-pdf', $this->data);
