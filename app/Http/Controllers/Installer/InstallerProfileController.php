...
class InstallerProfileController extends InstallerBaseController
{
    ...
    public function index() {
        ...
        return view('installer.profile.edit', $this->data);
    }
    ...
    public function update(UpdateProfile $request, $id) {
        ...
        return Reply::redirect(route('installer.profile.index'), __('messages.profileUpdated'));
    }
