 ...
 */
class InstallerTasksController extends InstallerBaseController
{
    use ProjectProgress;
...
//      Send notification to user
    ...
    public function show($id)
    {
        ...
        return view('installer.tasks.show', $this->data);
    }
    ...
    public function edit($id)
    {
        ...
        $this->categories = TaskCategory::all();
        $view = view('installer.tasks.edit', $this->data)->render();
    ...
    public function changeStatus(Request $request)
    {
        ...
        if(auth()->user()->id == $task->user_id || $task->project->isProjectAdmin || $this->user->can('edit_tasks'))
        {
            ...
            $view = view('installer.tasks.task-list-ajax', $this->data)->render();
