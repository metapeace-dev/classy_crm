 ...
 */
class InstallerProjectFilesController extends InstallerBaseController
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->view == 'list') {
            $view = view('installer.project-files.ajax-list', $this->data)->render();
        } else {
            $view = view('installer.project-files.thumbnail-list', $this->data)->render();
        }
    ...
    public function show($id)
    {
        ...
        return view('installer.project-files.show', $this->data);
    }
