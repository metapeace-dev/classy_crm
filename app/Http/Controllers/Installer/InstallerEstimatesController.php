...
use App\Http\Controllers\Designer\InstallerBaseController;
...
class InstallerEstimatesController extends InstallerBaseController
{
    ...
    public function index()
    {
        ...
        return view('installer.estimates.index', $this->data);
    }
    ...
    public function create()
    {
        ...
        return view('installer.estimates.create', $this->data);
    }
    ...
    public function store(StoreEstimate $request)
    {
        ...
        return Reply::redirect(route('installer.estimates.index'), __('messages.estimateCreated'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('installer.estimates.edit', $this->data);
    }
    ...
    public function update(StoreEstimate $request, $id)
    {
        ...
        return Reply::redirect(route('installer.estimates.index'), __('messages.estimateUpdated'));
    }
