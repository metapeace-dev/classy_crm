...
class InstallerSubTaskController extends InstallerBaseController
{
    ...
    public function create(Request $request)
    {
        ...
        return view('installer.sub_task.create', $this->data);
    }
    ...
    public function store(StoreSubTask $request)
    {
        ...
        $view = view('installer.sub_task.show', $this->data)->render();
