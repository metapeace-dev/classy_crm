...
class InstallerTaskboardController extends InstallerBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $view = view('installer.taskboard.board_data', $this->data)->render();
            return Reply::dataOnly(['view' => $view]);
        }
        return view('installer.taskboard.index', $this->data);
    }
    ...
    {
        return view('installer.taskboard.create', $this->data);
    }
    ...
    public function store(StoreTaskBoard $request)
    {
        ...
        return Reply::redirect(route('installer.taskboard.index'), __('messages.boardColumnSaved'));
    }
    ...
    public function edit($id)
    {
        ...
        $view =  view('installer.taskboard.edit', $this->data)->render();
