...
class InstallerAllTimeLogController extends InstallerBaseController
{
    ...
    public function index()
    {
        ...
        return view('installer.time-log.index', $this->data);
    }
        ...
        return DataTables::of($timeLogs)
            ...
            ->editColumn('project_name', function ($row) use ($logTimeFor) {
                if ($logTimeFor != null && $logTimeFor->log_time_for == 'task') {
                    ...
                    return '<a href="' . route('installer.projects.show', $row->project_id) . '">' . ucfirst($row->project_name) . '</a>';
                }
            })
    ...
    public function edit($id) {
        ...
        return view('installer.time-log.edit', $this->data);
    }
    ...
    public function membersList($projectId){
        if($this->user->can('add_timelogs')){
            ...
            $this->members = ProjectInstaller::where('project_id', $projectId)
    ...
    public function showActiveTimer()
    {
        ...
        return view('installer.time-log.show-active-timer', $this->data);
    }
    ...
    public function stopTimer(Request $request){
        ...
        $this->activeTimers = ProjectTimeLog::whereNull('end_time')
            ->get();
        $view = view('installer.time-log.active-timers', $this->data)->render();
        $buttonHtml = '';
