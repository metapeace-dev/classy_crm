 ...
 */
class InstallerProjectsMemberController extends InstallerBaseController
{
    ...
    public function show($id)
    {
        ...
        $this->employees = User::doesntHave('member', 'and', function($query) use ($id){
            ...
            ->get();
        return view('installer.project-member.show', $this->data);
    }
    ...
    {
        $projectMember = ProjectInstaller::findOrFail($id);
