...
//        }
    ...
    public function toMail($notifiable)
    {
        ...
        $content = '<p><b>Task Name: ' . ucfirst($this->task->heading) . '</b></p>
            <p><b>Priority: ' . $this->task->priority . '</b></p>
            <p><b style="color: green">Start On: ' . $this->task->start_date->format('d M, Y') . '</b></p>
            <p><b style="color: green">Due On: ' . $this->task->due_date->format('d M, Y') . '</b></p>';
