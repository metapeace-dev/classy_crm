    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('installer.attendances.index') }}">{{ $pageTitle }}</a></li>
...
<script>
    ...
    function checkHoliday() {
        ...
        $.easyAjax({
            url: '{{route('installer.attendances.check-holiday')}}',
            type: "GET",
            data: {
                date: selectedDate,
                _token: token
    ...
    function showTable(){
        table = $('#attendance-table').dataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{!! route('installer.attendances.data') !!}",
                data: function (d) {
    ...
    $('#attendance-table').on('click', '.save-attendance', function () {
        ...
        $.easyAjax({
            url: '{{route('installer.attendances.storeAttendance')}}',
            type: "POST",
   ...
   function attendanceDetail(id,attendanceDate) {
       var url = "{{ route('installer.attendances.detail') }}?userID="+id+"&date="+attendanceDate;
