    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                <a href="{{ route('installer.attendances.create') }}"
...
<script>
    ...
    function showTable() {
        ...
        //refresh counts
        var url = '{!!  route('installer.attendances.refreshCount') !!}';
        ...
        //refresh datatable
        var url2 = '{!!  route('installer.attendances.employeeData') !!}';
    ...
    $('#attendanceData').on('click', '.delete-attendance', function(){
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('installer.attendances.destroy',':id') }}";
...
<script>
    $('#clock-in').click(function () {
        ...
        $.easyAjax({
            url: '{{route('installer.attendances.store')}}',
            type: "POST",
            data: {
    ...
    $('#clock-out').click(function () {
        ...
        $.easyAjax({
            url: '{{route('installer.attendances.update', $currenntClockIn->id)}}',
            type: "PUT",
            data: {
                _token: token
            },
