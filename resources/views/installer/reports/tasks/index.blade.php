...
<script>
    ...
    $('#filter-results').click(function () {
        ...
        var url = '{{ route('installer.task-report.store') }}';
...
<script>
    ...
    function showTable() {
        ...
        var url = '{!!  route('installer.task-report.data', [':startDate', ':endDate', ':employeeId', ':projectId']) !!}';
    ...
    function exportData(){
        ...
        var url = '{!!  route('installer.task-report.export', [':startDate', ':endDate', ':employeeId', ':projectId']) !!}';
