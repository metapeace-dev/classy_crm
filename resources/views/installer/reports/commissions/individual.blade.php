        ...
        <section>
            <div class="sttabs tabs-style-line">
                <div class="white-box">
                    <nav>
                        <ul>
                            <li><a href="{{ route('installer.commission-report.index') }}"><span>Commissions</span></a>
                            <li class="tab-current"><a href="{{ route('installer.commission-report.individual') }}"><span>Individual Report</span></a>
                            </li>
                        </ul>
                    </nav>
                </div>
...
<script>
    ...
    function showTable() {
        ...
        let url = '{!!  route('installer.commission-report.individual-data') !!}';
        let reqData = {};
    ...
    function exportData(){
        let url = '{!!  route('installer.commission-report.individual-export') !!}'+'?'+$('#report_filter_form').serialize();
