        ...
        <section>
            <div class="sttabs tabs-style-line">
                <div class="white-box">
                    <nav>
                        <ul>
                            <li class="tab-current"><a href="{{ route('installer.commission-report.index') }}"><span>Commissions</span></a>
                            <li><a href="{{ route('installer.commission-report.individual') }}"><span>Individual Report</span></a>
                            </li>
                        </ul>
                    </nav>
                </div>
...
<script>
    ...
    function showTable() {
        let url = '{!!  route('installer.commission-report.data') !!}';
    ...
    function exportData(){
        let url = '{!!  route('installer.commission-report.export') !!}'+'?'+$('#report_filter_form').serialize();
        window.location.href = url;
    }

    $(document).on('click', '.btn_send_email',function(){
        let id = $(this).data('id');
        var url = '{{ route("installer.commission-report.email", [':id']) }}';
