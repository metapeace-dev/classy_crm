...
{{--                            <a href="{{ route('installer.projects.create') }}" class="btn btn-outline btn-success btn-sm">@lang('modules.projects.addNewProject') <i class="fa fa-plus" aria-hidden="true"></i></a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('installer.projects.destroy',':id') }}";
...
//                                    swal("Deleted!", response.message, "success");
    ...
    function showData(){
        ...
        table = $('#project-table').dataTable({
            ...
            destroy: true,
            order: [],
            ajax: '{!! route('installer.projects.data') !!}'+searchQuery,
            deferRender: true,
            language: {
