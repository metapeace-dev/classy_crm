                    ...
                    <div class="white-box">
                        <nav>
                            <ul>
                                ...
                                <li><a href="{{ route('installer.tasks.show', $project->id) }}"><span>@lang('app.menu.tasks')</span></a></li>
                                @endif

                                <li class="tab-current"><a href="{{ route('installer.files.show', $project->id) }}"><span>@lang('modules.projects.files')</span></a> </li>
                                ...
                                <div class="col-md-12" id="files-list-panel">
                                    <div class="white-box">
                                        ...
                                        <div class="row m-b-20 hide" id="file-dropzone">
                                            <div class="col-md-12">
                                                <form action="{{ route('installer.files.store') }}" class="dropzone"
                                                        ...
                                                        <li class="list-group-item">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <a href="{{ route('installer.files.download', $file->id) }}"
...
//        maxFilesize: 2, // MB,
    ...
    $('body').on('click', '.sa-params', function () {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('installer.files.destroy',':id') }}";
    ...
    $('.thumbnail').on('click', function(event) {
        ...
        $.easyAjax({
            type: 'GET',
            url: "{{ route('installer.files.thumbnail') }}",
            data: {
                id: projectID
            },
            success: function (response) {
