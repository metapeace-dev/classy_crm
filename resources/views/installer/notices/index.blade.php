                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            @if($user->can('add_notice'))
                                <a href="{{ route('installer.notices.create') }}" class="btn btn-outline btn-success btn-sm">@lang('modules.notices.addNotice') <i class="fa fa-plus" aria-hidden="true"></i></a>
                            @endif
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('installer.notices.destroy',':id') }}";
...
//                                    swal("Deleted!", response.message, "success");
    ...
    function showNoticeModal(id) {
        var url = '{{ route('installer.notices.show', ':id') }}';
        url = url.replace(':id', id);
    ...
    function loadTable () {
        ...
        table = $('#notice-table').dataTable({
            ...
            serverSide: true,
            destroy: true,
            ajax: '{!! route('installer.notices.data') !!}?startDate=' + startDate + '&endDate=' + endDate,
            language: {
