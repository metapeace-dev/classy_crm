...
<script>
    ...
    function showTable() {
        ...
        var url = '{!!  route('installer.ticket-agent.refreshCount', [':startDate', ':endDate', ':status', ':priority', ':channelId', ':typeId']) !!}';
        ...
        //refresh datatable
        var url2 = '{!!  route('installer.ticket-agent.data', [':startDate', ':endDate', ':status', ':priority', ':channelId', ':typeId']) !!}';
    ...
    $('body').on('click', '.sa-params', function () {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('installer.ticket-agent.destroy',':id') }}";
