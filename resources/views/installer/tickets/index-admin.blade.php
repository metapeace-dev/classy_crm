                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <a href="{{ route('installer.tickets.create') }}"
...
<script>
    ...
    function showTable() {
        ...
        var url = '{!!  route('installer.tickets.refreshCount', [':startDate', ':endDate', ':agentId', ':status', ':priority', ':channelId', ':typeId']) !!}';
        ...
        //refresh datatable
        var url2 = '{!!  route('installer.tickets.adminData', [':startDate', ':endDate', ':agentId', ':status', ':priority', ':channelId', ':typeId']) !!}';
    ...
    $('body').on('click', '.sa-params', function () {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('installer.tickets.destroy',':id') }}";
