            ...
            <section>
                <div class="sttabs tabs-style-line">
                    <div class="white-box">
                        <nav>
                            <ul>
                                <li class="tab-current"><a href="{{ route('installer.project-template.show', $project->id) }}"><span>@lang('modules.projects.overview')</span></a>
                                </li>
                                @if(in_array('employees',$modules))
                                <li><a href="{{ route('installer.project-template-member.show', $project->id) }}"><span>@lang('modules.projects.members')</span></a></li>
                                @endif
                                ...
                                <div class="col-md-6">
                                    <div class="white-box">
                                        <h3 class="b-b p-b-10">@lang('app.project') #{{ $project->id }} - <span
                                                    ...
                                                    href="{{ route('installer.project-template.edit', $project->id) }}" class="pull-right btn btn-info btn-outline btn-rounded" style="font-size: small"><i class="icon-note"></i> @lang('app.edit')</a></h3>
