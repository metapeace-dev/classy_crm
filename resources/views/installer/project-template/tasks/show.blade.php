...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-6 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="{{ route('installer.dashboard') }}">Home</a></li>
            ...
            <section>
                <div class="sttabs tabs-style-line">
                    <div class="white-box">
                        ...
                        <nav>
                            <ul>
                                <li ><a href="{{ route('installer.project-template.show', $project->id) }}"><span>@lang('modules.projects.overview')</span></a>
                                </li>
                                <li><a href="{{ route('installer.project-template-member.show', $project->id) }}"><span>@lang('modules.projects.members')</span></a></li>
                                <li class="tab-current"><a href="{{ route('installer.project-template-task.show', $project->id) }}"><span>@lang('app.menu.tasks')</span></a></li>
                            </ul>
                        </nav>
                    </div>
...
<script type="text/javascript">
    ...
    $('#save-task').click(function () {
        $.easyAjax({
            url: '{{route('installer.project-template-task.store')}}',
    ...
    taskListPanel.on('click', '.edit-task', function () {
        ...
        var url = "{{route('installer.project-template-task.edit', ':id')}}";
