                    ...
                    <div class="white-box">
                        ...
                        <nav>
                            <ul>
                                ...
                                <li class="tab-current"><a href="{{ route('installer.project-members.show', $project->id) }}"><span>@lang('modules.projects.members')</span></a></li>
...
<script type="text/javascript">
    ...
    $('#save-members').click(function () {
        $.easyAjax({
            url: '{{route('installer.project-members.store')}}',
    ...
    $('body').on('click', '.delete-members', function(){
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('installer.project-members.destroy',':id') }}";
