                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            @if($user->can('add_clients'))
                                <a href="{{ route('installer.clients.create') }}" class="btn btn-outline btn-success btn-sm">@lang('modules.client.addNewClient') <i class="fa fa-plus" aria-hidden="true"></i></a>
                            @endif
            ...
            $('body').on('click', '.sa-params', function(){
                ...
                swal({
                    ...
                    if (isConfirm) {
                        ...
                        var url = "{{ route('installer.clients.destroy',':id') }}";
...
//                                    swal("Deleted!", response.message, "success");
        ...
        function loadTable(){
            ...
            table = $('#users-table').dataTable({
                ...
                destroy: true,
                order: [],
                ajax: '{!! route('installer.clients.data') !!}?client=' + client + '&startDate=' + startDate + '&endDate=' + endDate,
                language: {
