            ...
            <section>
                <div class="sttabs tabs-style-line">
                    <div class="white-box">
                        <nav>
                            <ul>
                                <li><a href="{{ route('installer.projects.show', $project->id) }}"><span>@lang('modules.projects.overview')</span></a>
                                </li>
                                ...
                                <li class="tab-current"><a href="{{ route('installer.time-log.show-log', $project->id) }}"><span>@lang('app.menu.timeLogs')</span></a></li>
                                @endif
                            </ul>
                        </nav>
                    </div>
...
<script>
    var table = $('#timelog-table').dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '{!! route('installer.time-log.data', $project->id) !!}',
        deferRender: true,
        language: {
...
//        console.log(hours+" "+minutes);
    ...
    $('#save-form').click(function () {
        $.easyAjax({
            url: '{{route('installer.time-log.store-time-log')}}',
            container: '#logTime',
            type: "POST",
    ...
    $('body').on('click', '.sa-params', function(){
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('installer.all-time-logs.destroy',':id') }}";
...
//                                    swal("Deleted!", response.message, "success");
    ...
    $('body').on('click', '.edit-time-log', function () {
        ...
        var url = '{{ route('installer.time-log.edit', ':id')}}';
        url = url.replace(':id', id);
