        ...
        <div class="col-md-12">
            <div class="white-box">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <a href="{{ route('installer.all-tasks.create') }}" class="btn btn-outline btn-success btn-sm">@lang('modules.tasks.newTask') <i class="fa fa-plus" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function showTable() {
        ...
        var url = '{!!  route('installer.all-tasks.data') !!}?clientID='+clientID +'&assignedBY='+ assignedBY+'&assignedTo='+ assignedTo+'&status='+ status+'&_token={{ csrf_token() }}';
