        ...
        <section>
            <div class="sttabs tabs-style-line">
                <div class="white-box">
                    <nav>
                        <ul>
                            <li><a href="{{ route('designer.commission-report.index') }}"><span>Commissions</span></a>
                            <li class="tab-current"><a href="{{ route('designer.commission-report.individual') }}"><span>Individual Report</span></a>
                            </li>
                        </ul>
                    </nav>
                </div>
...
<script>
    ...
    function showTable() {
        ...
        let url = '{!!  route('designer.commission-report.individual-data') !!}';
        let reqData = {};
    ...
    function exportData(){
        let url = '{!!  route('designer.commission-report.individual-export') !!}'+'?'+$('#report_filter_form').serialize();
