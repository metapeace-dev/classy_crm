                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="company_name" disabled name="company_name" class="form-control" value="{{ $lead->company_name ?? '' }}">
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-6 no-padding-left">
                                            <div class="form-group">
                                                <label class="control-label">@lang('modules.lead.first_name')</label>
                                                <input type="text" id="first_name" disabled name="first_name" class="form-control" value="{{ $lead->first_name ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6 no-padding">
                                            <div class="form-group">
                                                <label class="control-label">@lang('modules.lead.last_name')</label>
                                                <input type="text" id="last_name" disabled name="last_name" class="form-control" value="{{ $lead->last_name ?? '' }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="source" id="source" class="form-control selectpicker" data-style="form-control" disabled>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2 select2-multiple" disabled data-placeholder="@lang('modules.interest_area.chooseArea')" name="interest_area[]" id="interest_area_id[]" multiple="multiple">
                                            <option value=""></option>
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <div class="col-md-8 no-padding-left">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" name="phone" disabled id="phone" class="form-control" value="{{ $lead->phone ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4 no-padding">
                                            <div class="form-group">
                                                <label>@lang('modules.lead.ext')</label>
                                                <input type="text" name="ext" id="ext" disabled class="form-control" value="{{ $lead->ext ?? '' }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>@lang('modules.lead.cell')</label>
                                        <input type="tel" name="cell" disabled id="cell" class="form-control" value="{{ $lead->cell ?? '' }}">
                                    </div>
                                    <div class="form-group">
                                        <label>@lang('modules.lead.cell') 2</label>
                                        <input type="tel" name="cell2" id="cell2" class="form-control" value="{{ $lead->cell2 ?? '' }}">
                                    </div>
                                    <div class="form-group">
                                        <label>@lang('modules.lead.fax')</label>
                                        <input type="tel" name="fax" disabled id="fax" class="form-control" value="{{ $lead->fax ?? '' }}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="second_email" id="second_email" class="form-control" value="{{ $lead->second_email ?? '' }}">
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" disabled data-placeholder="@lang('modules.tasks.chooseAssignee')" name="user_id" id="user_id" >
                                        <option value=""></option>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <a href="{{ route('designer.all-tasks.create') }}" class="btn btn-primary"><i class="ti-layout-list-thumb"></i> @lang('modules.tasks.newTask')</a>
                                </div>
                            </div>
                        </div>
