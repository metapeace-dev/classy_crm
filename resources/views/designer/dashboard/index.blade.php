    ...
    <div class="row dashboard-stats">
        ...
        @if(in_array('leads',$modules) && in_array('total_leads',$activeWidgets))
            <div class="col-md-3 col-sm-6">
                <a href="{{ route('designer.leads.index') }}">
                    <div class="white-box">
                        <div class="row">
                            <div class="col-xs-3">
                                <div>
                        ...
                        <div class="steamline">
                            @foreach($appointments as $appt)
                                <div class="sl-item">
                                    ...
                                    <div class="sl-right">
                                        <div><h6><a href="{{ route('designer.events.index') }}"
                                                    class="text-info">{{ ucwords($appt->event_name) }}
                        ...
                        <ul class="list-task list-group" data-role="tasklist">
                            @forelse($installs as $key=>$install)
                                <li class="list-group-item" data-role="task">
                                    {{ '#'.$install->id }}. <a href="{{ route('designer.projects.show', $install->id) }}"
                            ...
                            <div class="steamline">
                                @forelse($userActivities as $key=>$activity)
                                    <div class="sl-item">
                                        ...
                                        <div class="sl-right">
                                            <div class="m-l-40"><a
                                                        href="{{ route('designer.employees.show', $activity->user_id) }}"
