...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top m-b-0">
        <div class="navbar-header">
            ...
            <div class="top-left-part">
                <!-- Logo -->
                <a class="logo hidden-xs hidden-sm text-center" href="{{ route('installer.dashboard') }}">
    ...
    <!-- End Top Navigation -->
    <!-- Left navbar-header -->
@include('sections.installer_left_sidebar')
...
<script>
    ...
    $('body').on('click', '.active-timer-modal', function(){
        var url = '{{ route('installer.all-time-logs.show-active-timer')}}';
    ...
    function addOrEditStickyNote(id)
    {
        ...
        if(id === undefined || id == "" || id == null) {
            url =  '{{ route('installer.sticky-note.store') }}'
        } else{

            url = "{{ route('installer.sticky-note.update',':id') }}";
    ...
    function showCreateNoteModal(){
        var url = '{{ route('installer.sticky-note.create') }}';
    ...
    function showEditNoteModal(id){
        var url = '{{ route('installer.sticky-note.edit',':id') }}';
        url  = url.replace(':id',id);
    ...
    function deleteSticky(id){
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('installer.sticky-note.destroy',':id') }}";
                url = url.replace(':id', id);
    ...
    function getNoteData(){
        ...
        var url = "{{ route('installer.sticky-note.index') }}";
