                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6" id="designer_color_container" style="display: none;">
    ...
    <script>
        ...
        $('#role').on('change', function(e){
            if($(this).val() === '3'){
                ...
                $("#designer_color").spectrum("destroy");
                $('#designer_color_container').hide();
            }
        });
