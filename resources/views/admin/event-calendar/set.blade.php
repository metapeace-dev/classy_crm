        ...
        <div class="modal-dialog modal-lg" id="modal-data-application">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="storeDate" value="1">
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-6 ">
                            ...
                            <div class="radio-list">
                                <label class="radio-inline p-0 col-md-4 text-center">
                                    <div class="radio radio-info">
                                        <input type="radio" id="show_lead_container" name="active-container" value="0" @if(isset($lead)) checked  @else disabled @endif>
                                        <label for="show_lead_container">@lang('modules.events.lead')</label>
                                    </div>
                                </label>
                                <label class="radio-inline col-md-4 text-center">
                                    <div class="radio radio-info">
                                        <input type="radio" id="show_project_container" name="active-container" value="1" @if(isset($project)) checked  @else disabled @endif>
                                        <label for="show_project_container">@lang('modules.events.project')</label>
                                    </div>
                                </label>
                                <label class="radio-inline col-md-4 text-center">
                                    <div class="radio radio-info">
                                        <input type="radio" id="show_client_container" name="active-container" value="2" @if(isset($client)) checked  @else disabled @endif>
...
<script>
    ...
    var taskEvents = [
        ...
        {
            id: '{!! ucfirst($event->id) !!}',
            resourceId: '{!! !is_null($event->attendee) ? $event->attendee->user_id : '' !!}',
