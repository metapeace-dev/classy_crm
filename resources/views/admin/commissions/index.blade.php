            ...
            <div class="white-box">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <a href="{{ route('admin.commissions.create') }}" class="btn btn-outline btn-success btn-sm">Add Commission <i class="fa fa-plus" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover toggle-circle default footable-loaded footable" id="invoice-table">
                        ...
                        <tr>
                            <th>@lang('app.id')</th>
                            <th>@lang('modules.commissions.project') @lang('app.id')</th>
                            <th>@lang('modules.commissions.project')</th>
...
//                                    swal("Deleted!", response.message, "success");
    ...
    function loadTable(){
        ...
        table = $('#invoice-table').dataTable({
            ...
            serverSide: true,
            stateSave: false,
            ajax: '{!! route('admin.commissions.data') !!}?startDate=' + startDate + '&endDate=' + endDate + '&status=' + status + '&project=' + project + '&client=' + client,
            "order": [[ 0, "desc" ]],
            language: {
            ...
            columns: [
                ...
                { data: 'pay_start_date', name: 'pay_start_date' },
                { data: 'pay_end_date', name: 'pay_end_date' },
