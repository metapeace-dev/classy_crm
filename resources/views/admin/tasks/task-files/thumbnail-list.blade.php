            ...
            <div class="card">
                    ...
                    <div class="file-bg">
                        <div class="overlay-file-box">
                            <div class="user-content">
                                @if($file->icon == 'images')
                                <img class="card-img-top img-responsive" src="{{ asset_url('task-files/'.$task->id.'/'.$file->hashname) }}" alt="Card image cap">
                                @else
                ...
                @elseif(config('filesystems.default') == 's3')
                    <div class="file-bg">
                        <div class="overlay-file-box">
                            <div class="user-content">
                                @if($file->icon == 'images')
                                    <img class="card-img-top img-responsive" src="{{ $url.'task-files/'.$task->id.'/'.$file->filename }}" alt="Card image cap">
                                @else
                                    <i class="fa {{$file->icon}}" style="font-size: -webkit-xxx-large; padding-top: 65px;"></i>
                                @endif
                            </div>
                ...
                <div class="card-block">
                    ...
                    <a href="javascript:;" data-toggle="tooltip"
                       ...
                       class="btn btn-danger btn-circle sa-params delete-file" data-pk="thumbnail"><i
