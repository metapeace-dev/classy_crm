                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                @if(isset($leadDetail))
                                                    <input type="text" name="cell_contact"  id="cell_contact" class="form-control" value="{{ $leadDetail->cell_contact ?? '' }}">
                                                @elseif(isset($clientDetail))
                                                    <input type="text" name="cell_contact"  id="cell_contact" class="form-control" value="{{ $clientDetail->cell_contact ?? '' }}">
                                                @else
                                                    <input type="text" name="cell_contact"  id="cell_contact" class="form-control">
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                ...
                                                @if(isset($leadDetail))
                                                    <input type="tel" name="cell2"  id="cell2" class="form-control" value="{{ $leadDetail->cell2 ?? '' }}">
                                                @elseif(isset($clientDetail))
                                                    <input type="tel" name="cell2"  id="cell2" class="form-control" value="{{ $clientDetail->cell2 ?? '' }}">
                                                @else
                                                    <input type="tel" name="cell2"  id="cell2" class="form-control">
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                @if(isset($leadDetail))
                                                    <input type="text" name="cell2_contact"  id="cell2_contact" class="form-control" value="{{ $leadDetail->cell2_contact ?? '' }}">
                                                @elseif(isset($clientDetail))
                                                    <input type="text" name="cell2_contact"  id="cell2_contact" class="form-control" value="{{ $clientDetail->cell2_contact ?? '' }}">
                                                @else
                                                    <input type="text" name="cell2_contact"  id="cell2_contact" class="form-control">
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if(isset($leadDetail))
                                            <input type="email" name="second_email"  id="second_email" class="form-control" value="{{ $leadDetail->second_email ?? '' }}">
                                        @elseif(isset($clientDetail))
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 input-group">
                                        <input type="number" min="0.01" step="0.01" class="form-control" name="discount"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 input-group">
                                        <input type="number" min="0.01" step="0.01" class="form-control" name="commission"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
