...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading"> @lang('modules.projects.updateTitle') - #{{$project->id}}</div>
            <div class="panel-wrapper collapse in" aria-expanded="true">
                <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>@lang('modules.projects.cell') @lang('modules.projects.contact')</label>
                                            <input type="text" name="cell_contact" id="cell_contact" value="{{ $project->cell_contact ?? '' }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>@lang('modules.projects.cell') 2 @lang('modules.projects.contact')</label>
                                            <input type="text" name="cell2_contact" id="cell2_contact" value="{{ $project->cell2_contact ?? '' }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                    ...
                    <h3 class="box-title m-b-10">@lang('modules.projects.installerInfo')</h3>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">@lang('modules.projects.chooseInstaller')</label>
                                <select class="select2 select2-multiple" data-placeholder="@lang('modules.projects.chooseInstaller')" name="installers[]" id="installers" multiple="multiple">
                                    <option value=""></option>
                                    @foreach($installers as $installer)
                                        <option value="{{ $installer->id }}">{{ ucwords($installer->name) }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div>
                            <div class="col-md-6 clear">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="install_start_date" id="install_start_date" value="{{ $project->install_start_date ?? '' }}"  class="form-control" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">@lang('modules.projects.installEndDate')</label>
                                    <input type="text" name="install_end_date"  id="install_end_date" value="{{ $project->install_end_date ?? '' }}" class="form-control" autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-12 input-group">
                                    ...
                                    <input type="text" class="form-control" name="sales_price" value="{{ number_format($project->sales_price, 2, '.', ',') }}"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-12 input-group">
                                    <input type="number" min="0.01" step="0.01" class="form-control" name="discount" value="{{ $project->discount ?? '' }}"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-12 input-group">
                                    <input type="number" min="0.01" step="0.01" class="form-control" name="commission" value="{{ $project->commission ?? '' }}"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-12 input-group">
                                    <input type="text" class="form-control" name="commission" value="{{ !empty($commissions->totalCommissions) ? number_format($commissions->totalCommissions, 2, '.', ',') : '0' }}" disabled/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">Paid Amount</label>
                                <div class="col-md-12 input-group">
                                    <input type="text" class="form-control" name="commission" value="{{ !empty($commissions->paidCommissions) ? number_format($commissions->paidCommissions, 2, '.', ',') : '0' }}" disabled/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-12 input-group">
                                    <input type="text" class="form-control" name="commission" value="{{ !empty($commissions->pendingCommissions) ? number_format($commissions->pendingCommissions, 2, '.', ',') : '0' }}" disabled/>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    if(attendees.length > 0) {
        $(function () {
            $('#installers').select2('val', attendees);
        });
    }
